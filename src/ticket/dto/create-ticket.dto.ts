...
export class CreateTicketDto {
  @ApiProperty({
    ...
    description: 'The ID of the user buying the ticket',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    description: 'The ID of the seat being booked',
  })
  ...
  @ApiProperty({
    example: 25.5,
    description: 'The total amount paid for the ticket',
  })
  ...
  @IsEnum(TicketStatus, {
    message:
      'Status must be a valid TicketStatus (PENDING, CONFIRMED, CANCELLED, COMPLETED).',
  })
  status!: TicketStatus;
}
